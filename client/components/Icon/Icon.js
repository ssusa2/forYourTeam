...
export const Edit = () => {
	return (
		<svg
			...
			strokeWidth={2}
			stroke='currentColor'
			className='w-4 h-4 hover:stroke-white'
		>
			<path
				strokeLinecap='round'
...
export const ArrowUp = () => {
	return (
		<svg
			...
			strokeWidth={2}
			stroke='currentColor'
			className='w-6 h-6 stroke-white drop-shadow-xl'
		>
			<path
				strokeLinecap='round'
				strokeLinejoin='round'
...
export const NonHeart = () => {
	return (
		<svg
			...
			strokeWidth={2}
			stroke='currentColor'
			className='w-4 h-4 cursor-pointer hover:stroke-green-700		'
		>
			<path
				strokeLinecap='round'
				strokeLinejoin='round'
...
export const Heart = () => {
	return (
		<svg
			...
			viewBox='0 0 24 24'
			fill='currentColor'
			className='w-4 h-4 cursor-pointer fill-green-600	'
		>
